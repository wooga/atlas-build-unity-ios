...
class IOSBuildPluginIntegrationSpec extends IOSBuildIntegrationSpec {
    ...
    def "sets convention for task type #taskType.simpleName and property #property"() {
        ...
        SighRenew              | "readOnly"           | true                                | "Boolean"     | _                                                             | _   | _
        SighRenew              | "skipInstall"        | true                                | "Boolean"     | _                                                             | _   | _
    ...
    def "extension property #property of type #type sets #rawValue when #location"() {
        ...
        "provisioningProfiles"              | assignment                         | ["net.test.foo": "Provisoning Name Foo"]                                                   | "Map<String, String>"           | PropertyLocation.script
        "provisioningProfiles"              | providerSet                        | ["net.test.foo": "Provisoning Name Foo"]                                                   | "Map<String, String>"           | PropertyLocation.script
        "provisioningProfiles"              | providerSet                        | ["net.test.foo": "Provisoning Name Foo"]                                                   | "Provider<Map<String, String>>" | PropertyLocation.script
        "provisioningProfiles"              | setter                             | ["net.test.foo": "Provisoning Name Foo"]                                                   | "Map<String, String>"           | PropertyLocation.script
        "provisioningProfiles"              | setter                             | ["net.test.foo": "Provisoning Name Foo"]                                                   | "Provider<Map<String, String>>" | PropertyLocation.script
        "provisioningProfiles"              | _                                  | [:]                                                                                        | _                               | PropertyLocation.none
